...
#include "WprimeAnalysis/WprimeENUAnalysis/plugins/WprimeTreePAT.h"
...
void WprimeTreePAT::analyze (const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  naiveId_++;
...
void WprimeTreePAT::dumpSuperclusterInfo ( const reco::SuperClusterCollection* theBarrelSuperClusters ,
...
// dump CALO MET Info
void WprimeTreePAT::dumpCALOMetInfo ( View<pat::MET>  mets ,
				   WprimeTreeContent & myTreeVariables_)
...
// dump TC MET Info
void WprimeTreePAT::dumpTCMetInfo ( View<pat::MET>  mets ,
				 WprimeTreeContent & myTreeVariables_)
...
// dump PF MET Info
void WprimeTreePAT::dumpPFMetInfo ( View<pat::MET>  mets ,
				 WprimeTreeContent & myTreeVariables_)
...
// dump JET Info
void WprimeTreePAT::dumpJetInfo ( View<pat::Jet>  jets ,
			       WprimeTreeContent & myTreeVariables_)
...
void WprimeTreePAT::dumpMuonInfo ( View<pat::Muon>  muons ,
			       WprimeTreeContent & myTreeVariables_)
...
// dump L1Info
void WprimeTreePAT::dumpL1Info ( edm::Handle<L1GlobalTriggerReadoutRecord>  gtRecord ,
			    WprimeTreeContent & myTreeVariables_)
{
...
// dump HLTInfo
void WprimeTreePAT::dumpHLTInfo ( Handle<TriggerResults>  hltresults ,
			           ...
			           WprimeTreeContent & myTreeVariables_)
{
  ...
  if(hltresults.isValid()) {
    ...
    edm::LogError("WprimeTreePAT ---> ") << "ERROR! INVALID  TriggerResults  " ;
  }
