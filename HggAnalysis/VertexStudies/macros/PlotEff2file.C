{
  ...
  string legtitle1 = "SumPt2 Hgg PU2010";
  string legtitle1bdt = "Hgg PU2010";
  
  string legtitle2 = "SumPt2 Zee PU2010";
  ...
  EtaPt2_1->Sumw2();  EtaBDT_1->Sumw2(); EtaAll_1->Sumw2();
  ...
  eff2D_BDT_2 -> Divide(PtBDT_vsNvtBDT_2,PtAll_vsNvtAll_2);
   ...
   float eff1 = PtPt2_1->GetEntries()/ PtAll_1->GetEntries();
   float eff2 = PtPt2_2->GetEntries()/ PtAll_2->GetEntries();

   float eff1bdt = PtBDT_1->GetEntries()/ PtAll_1->GetEntries();
   float eff2bdt = PtBDT_2->GetEntries()/ PtAll_2->GetEntries();
