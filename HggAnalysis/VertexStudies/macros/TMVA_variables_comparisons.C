{
  ...
  tracksNum1.SetFillStyle(3002);

  TH1F tracksNum2("tracksNum2","tracksNum2",200,0.,200.);
  tracksNum2.SetLineColor(4);
  tracksNum2.SetFillColor(4);
  tracksNum2.SetFillStyle(3002);

  TH1F deltaPhi1("deltaPhi1","deltaPhi1",150,0.,3.15);
  deltaPhi1.SetLineColor(2);
  deltaPhi1.SetFillColor(2);
  deltaPhi1.SetFillStyle(3002);

  TH1F deltaPhi2("deltaPhi2","deltaPhi2",150,0.,3.15);
  deltaPhi2.SetLineColor(4);
  deltaPhi2.SetFillColor(4);
  deltaPhi2.SetFillStyle(3002);

  ntu1->Draw("nTracksPt05 >> tracksNum1","isSig == 1 && sum2PhoPt > 10 && sum2PhoPt < 15 ","goff");
  ntu2->Draw("nTracksPt05 >> tracksNum2","isSig == 1 && sum2PhoPt > 10 && sum2PhoPt < 15","goff");
